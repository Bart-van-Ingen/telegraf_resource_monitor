...
def generate_launch_description():
    ...
    resource_monitor_py_launch_dir = PathJoinSubstitution(
        [FindPackageShare('resource_monitor_py'), 'launch']
    )
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                PathJoinSubstitution(
                    [
                        resource_monitor_py_launch_dir,
                        'resource_monitor_launch.py',
                    ]
                ),
                launch_arguments={
                    'config_file_path': LaunchConfiguration('config_file_path'),
